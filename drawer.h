...
public:
    ...
    void render_texture(SDL_Texture* const texture, rect_t rect) const noexcept {
        if (SDL_RenderTexture(renderer_, texture, nullptr, &rect))
    ...
    void draw_filled_circle(f32 x, f32 y, f32 radius) const noexcept;
};
